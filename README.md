...
The AI4SG curriculum engages undergraduate students from **all disciplines** to propose or develop AI-powered solutions addressing pressing community issues aligned with the UN SDGs. It has been adopted across **3 universities**, **4 disciplines**, and has engaged **2,500+ undergraduate students**.

The curriculum is structured around two intervention levels:
...
> Current version, used from 2024 onward. Students build and deploy working AI prototypes using OpenAI tools, progressing from setup through full application deployment.

| Lab | Topic | Repository |
|-----|-------|------------|
| Lab 1 | Setting Up for OpenAI Development | [Lab1-openai-setup](https://github.com/TEAMAI4SG/Lab1-openai-setup) |
| Lab 2 | Generating Text with OpenAI | [Lab2-Generating-Text](https://github.com/TEAMAI4SG/Lab2-Generating-Text) |
| Lab 3 | Generating Images with OpenAI | [Lab3-Generating-Images](https://github.com/TEAMAI4SG/Lab3-Generating-Images) |
| Lab 4 | Audio Transcription | [Lab4-Audio-Transcription](https://github.com/TEAMAI4SG/Lab4-Audio-Transcription) |
| Lab 5 | Prompt Engineering | [Lab5-Prompt-Engineering](https://github.com/TEAMAI4SG/Lab5-Prompt-Engineering) |
...
See what students have built using this curriculum:  
👉 [aiforsocialgood.org/projects](https://www.aiforsocialgood.org/projects)

---

## 📚 Full Publication List

👉 [aiforsocialgood.org/publications](https://www.aiforsocialgood.org/publications)
